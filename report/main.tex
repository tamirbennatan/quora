...
Tamir engineered the features described, contributed to the classifiers built, and conducted model experiments. Jack contributed to the classifiers and paper, and experimented with advanced features, such as Named Entity Recognition and headword extraction. 
